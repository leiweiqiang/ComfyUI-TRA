...
class TclFresco:
    ...
    def log(self, message, level="info"):
        ...
        self.prompt_server.send_sync("fresco_log", data)
    ...
    def fresco(self, model_type, controlnet_strength, ip_adapter_scale, max_images, prompt, negative, video_path, save_path, ref_img_ip_adapter, prompt_id):
        ...
        try:
            ...
            if return_code == 0:
                ...
                return ("FRESCO completed successfully", f"{folder_paths.get_output_directory()}/{save_path}/out.mp4", f"{folder_paths.get_output_directory()}/{save_path}/raw_keyframes.mp4", f"{folder_paths.get_output_directory()}/{save_path}/combined.mp4", )
            else:
