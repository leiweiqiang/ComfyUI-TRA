...
def load_images(directory: str, image_load_cap: int = 0, skip_first_images: int = 0, select_every_nth: int = 1, meta_batch=None, unique_id=None):
    ...
    return images, masks, images.size(0), get_sorted_dir_files_from_directory(directory, skip_first_images, select_every_nth, FolderOfImages.IMG_EXTENSIONS)
...
class LoadImagesFromDirectoryUpload:
    ...
    RETURN_TYPES = ("IMAGE", "MASK", "INT", "PATH")
